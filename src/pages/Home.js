        ...
        <div className="wrapper">
          <div className="hero-banner">
            ...
            <div className="sec-text">
              <p>
                Je suis <strong>Sid Ahmed Baroutchi</strong>, un développeur web
                front-end axée sur la conception et la création de belles
              ...
              <div className="sec-btn">
                ...
                >
                  ...
                  <div className={`ligne-blue ${isHover ? "active" : ""}`} />
                </div>
              </div>
            </div>
          </div>
