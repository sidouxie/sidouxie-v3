            ...
            <div className="row">
              <div className="section-textil">
                ...
                <div className="textil">
                  <p>
                    Le respect de votre vie privée est de la plus haute
                  ...
                  <p>
                    ...
                    votre âge, de votre adresse postale, de votre adresse
                    ...
                    collectés et traités ; À qui ces renseignements sont
                    transmis ; Éventuellement, la politique du site en matière
                    de fichiers témoins ("cookies"). Cette politique de
                    confidentialité complète les Conditions générales
                    d'utilisation que vous pouvez consulter à l'adresse ci-après
                    :
                  </p>
                ...
                <div className="textil">
                  <p>
                    Vos renseignements personnels sont également collectés par
                    le biais de l'interactivité pouvant s'établir entre vous et
                    notre site Web. Ces renseignements sont collectés par les
                    moyens suivants :
                  </p>
                  <ul>
                ...
                <div className="textil">
                  ...
                  <p>
                    ...
                    Cookies Le recours à de tels fichiers nous permet
                    d'atteindre les objectifs suivants : Amélioration du service
                    et accueil personnalisé Création de profils personnalisés de
                    consommation Suivis de commande Études statistiques En
                    navigant sur le site, des fichiers témoins de tiers peuvent
                    être enregistrés. Il s'agit particulièrement des tiers
                    suivants : Cookies De plus, le site intègre des boutons de
                    réseaux sociaux vous permettant de partager votre activité
                    sur le site. Des fichiers témoins de ces réseaux sociaux
                    sont par conséquent susceptibles d'être stockés sur votre
                    ordinateur lorsque vous utilisez ces fonctionnalités. Ces
                    sites disposent de politiques de confidentialité propres et
                    de conditions générales d'utilisation possiblement
                    différentes de notre site. Nous vous invitons à consulter
                    les politiques de confidentialité et les conditions
                    générales d'utilisation de ces sites.
                  </p>
                  <strong>
                    b) Opposition à l'utilisation de fichiers témoins par le
                    site
                  </strong>
                  <p>
                    ...
                    manipulation ne peut être considéré comme étant de notre
                    fait.
                  </p>
                </div>
                ...
                <div className="textil">
                  <p>
                    ...
                    conservera dans ses systèmes informatiques du site et dans
                    des conditions raisonnables de sécurité l'ensemble des
                ...
                <div className="textil">
                  ...
                  <p>
                    Le responsable du traitement des renseignements personnels
                    est : sidouxie.com. Il peut être contacté de la manière
                    suivante :
                  </p>
                  <Link to="/">sidouxie.com</Link>
                  <p>
                    Le responsable du traitement des renseignements personnels
                    est chargé de déterminer les finalités et les moyens mis au
                  ...
                  <p>
                    Le responsable du traitement des renseignements personnels
                    s'engage à protéger les renseignements personnels collectés,
                    à ne pas les transmettre à des tiers sans que vous n'en ayez
                    été informé(e) et à respecter les finalités pour lesquelles
                    ces renseignements ont été collectés. De plus, le
                    responsable du traitement des renseignements personnels
                    s'engage à vous aviser en cas de rectification ou de
                    suppression des renseignements personnels, à moins que cela
                    n'entraîne pour lui des formalités, coûts ou démarches
                    disproportionnés. Dans le cas où l'intégrité, la
                    confidentialité ou la sécurité de vos renseignements
                ...
                <div className="textil">
                  <p>
                    ...
                    d'opposition"). Vous avez également le droit de demander à
                    ...
                    renseignements personnels, vous devez suivre la procédure
                    suivante :
                  </p>
                  <Link to="/">sidouxie.com</Link>
                </div>
                ...
                <div className="textil">
                  ...
                  <p>
                    ...
                    technologiques permettant d'assurer la confidentialité de
                    vos transactions. Toutefois, comme aucun mécanisme n'offre
                    une sécurité maximale, une part de risque est toujours
                    présente lorsqu'on utilise Internet pour transmettre des
                ...
                <div className="textil">
                  <p>
                    La présente politique de confidentialité peut être consulté
                    à tout moment à l'adresse ci-après indiquée :
                  </p>
                  ...
                  <p>
                    ...
                    êtes invité(e) à venir consulter régulièrement cette
                    politique de confidentialité afin de vous tenir informé(e)
                    des derniers changements qui lui seront apportés. Toutefois,
                    en cas de modification substantielle de cette politique,
                    vous en serez informé(e) de la manière suivante.
                  </p>
                </div>
              </div>
            </div>
